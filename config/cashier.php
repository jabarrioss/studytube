...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can define your Paddle price IDs for different subscription
    | plans. These IDs are obtained from your Paddle dashboard after
    | creating products and prices.
    |
    */

    'price_ids' => [
        'premium' => env('PADDLE_PREMIUM_PRICE_ID', 'pri_01jwxxxxxxxxxxxxxxxxxx'), // Replace with actual Paddle price ID
    ],
