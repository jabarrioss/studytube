<x-guest-layout>
    <div class="text-center mb-6">
        <h2 class="text-3xl font-bold text-gray-900">Start Learning</h2>
        <p class="mt-2 text-sm text-gray-600">Create your account and take timestamped notes on any YouTube video</p>
    </div>
